...
class PaymentCommandEndpointHttpDrivingAdapterContractTests : WithHttp4kOpenApiValidationSupport, HttpApiDefinition by HttpApiDefinition.companyWide, CoreDataGenerator by CoreDataGenerator.testProvider, LocalHttpDrivingAdapterTestSpecification, OpenApiProvider by OpenApiProvider.standard {
    ...
    @Nested
    inner class SendPaymentCommandEndpoint : SendPaymentCommandEndpointHttpTestSpecification, WithHttp4kOpenApiValidationSupport by this, HttpApiDefinition by this, CoreDataGenerator by this, LocalHttpDrivingAdapterTestSpecification by this
}